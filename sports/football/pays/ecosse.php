...
<?php include '../../../boutons.php'?>;
    ...
    <?php echo $test=fonction_match('ecosse',"premier-league"); ?>
    <?php echo $test=fonction_match('ecosse','division-1'); ?>
    <?php echo $test=fonction_match('ecosse','division-2'); ?>
    <?php echo $test=fonction_match('ecosse','division-3'); ?>
