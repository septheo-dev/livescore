...
<?php include '../../../boutons.php'?>;
    ...
    <?php echo $test=fonction_match('angleterre','barclays-premiership-premier-league'); ?>
    <?php echo $test=fonction_match('angleterre','championship'); ?>
    <?php echo $test=fonction_match('angleterre','league-one'); ?>
