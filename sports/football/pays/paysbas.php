...
<?php include '../../../boutons.php'?>;
    ...
    <?php echo $test=fonction_match("pays-bas","eredivisie"); ?>
    <?php echo $test=fonction_match('pays-bas','jupiler-league'); ?>
    <?php echo $test=fonction_match('pays-bas','tweede-divisie'); ?>
