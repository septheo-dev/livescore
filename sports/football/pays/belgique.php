...
<?php include '../../../boutons.php'?>;
    ...
    <?php echo $test=fonction_match("belgique","jupiler-league"); ?>
    <?php echo $test=fonction_match('belgique','2e-klasse'); ?>
    <?php echo $test=fonction_match('belgique','3eme-division'); ?>
