...
<?php include '../../../boutons.php'?>;
    ...
    <?php echo $test=fonction_match("espagne","primera-division"); ?>
    <?php echo $test=fonction_match('espagne','segunda-division-liga-adelante'); ?>
    <?php echo $test=fonction_match('espagne','segunda-b'); ?>
