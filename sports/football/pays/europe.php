...
<?php include '../../../boutons.php'?>;
    ...
    <?php echo $test=fonction_match('europe','ligue-des-champions-uefa'); ?>

    <?php echo $test=fonction_match('europe','uefa-europa-league'); ?>

    <?php echo $test=fonction_match("europe","championnat-europeen"); ?>
