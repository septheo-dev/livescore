    <div id="championnats">
      ...
      <a type="button" href="ligue1.php" id="bouton" class ="bouton_football">
          <h2>Ligue 1</h2>
      </a>

      <a type="button" href="premierleague.php" id="bouton" class ="bouton_football">
          <h2>Premier League</h2>
      </a>

      <a type="button" href="liga.php" id="bouton" class ="bouton_football">
          <h2>Liga</h2>
      </a>

      <a type="button" href="serieA.php" id="bouton" class ="bouton_football">
          <h2>Serie A</h2>
      </a>

      <a type="button" href="bundesliga.php" id="bouton" class ="bouton_football">
          <h2>Bundesliga</h2>
      </a>
